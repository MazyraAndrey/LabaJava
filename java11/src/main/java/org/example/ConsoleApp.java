    ...
    private static void showProductsByPerson(Session session, String[] tokens) {
        ...
        try {
            ...
            if (customer != null) {
                ...
                System.out.println("Продукты, купленные " + customer.getProducts() + ":");
...
//                }
//
//                productSums.forEach((productName, totalCost) -> System.out.println(productName + " " + totalCost + " Рублей"));
            } else {
    ...
    private static void findPersonsByProductTitle(Session session, String[] tokens) {
        ...
        try {
            ...
            productsByCustomer.forEach((customerId, customerProducts) -> {
                ...
                customerProducts.forEach(p -> System.out.print(", [" + p.getProductName() + ", " + p.getProductPrice() + " рублей]"));
                System.out.println();
            });
        } catch (Exception e) {
            e.printStackTrace();
